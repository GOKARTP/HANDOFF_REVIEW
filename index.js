...
// Опять срём в глобал без причины
// Есть мнение, что глобальные константы безобидны. Может это и так, когда
// проект структурирован - всё в одном месте, легко поправить.
// В данном случае глобальные константы ни чуть не лучше глобальных переменных,
// потому что расползлись по всему коду и всё еще отжирают оперативу весь жизненный цикл,
// а нужны далеко не всегда.
const colors = [
    "#bf1765",
    "#3eedcd",
    "#beed3e",
...
// Опять срём в глобал без причины. Да блядь, когда это закончится?
let vibes_audio = {
...
// Посчитайте "Опять срём в глобал без причины."
